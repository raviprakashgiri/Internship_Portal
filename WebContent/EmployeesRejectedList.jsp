<%-- 
    Document   : Employers Rejected List
...
<%
	String query = "select job_applicant_id,first_name,cgpa,total_experience,qualification,availability_f2f,email_id from job_applicant where status='Rejected'";
