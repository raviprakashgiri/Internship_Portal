...
<%
	String query = "select job_applicant_id,first_name,cgpa,total_experience,qualification,availability_f2f,email_id from job_applicant where status='ShortListed'";
	...
	<td bgcolor="#FFFFFF"><table width="98%" border="0" align="center"
			...
			<tr align="left" bgcolor="#FFFFFF" class="table_head">
				...
				<td width="13%" height="25" align="left"
				 ...
				 <td width="13%" align="left" style="border-bottom:1px solid; border-color:#FF6600;">CGPA</td> 
				<td width="13%" align="left"
					style="border-bottom: 1px solid; border-color: #FF6600;">Experience in months</td>
				<td width="13%" align="left" bgcolor="#FFFFFF"
					style="border-bottom: 1px solid; border-color: #FF6600;">Highest Qualification</td>
				<td width="13%" align="left" bgcolor="#FFFFFF"
			...
			<tr>
				...
				<td align="left" class="tdbgwhite"><a href="JobApplicantDetails.jsp?job_applicant_id=<%=data[count][0]%>">View</a></td>
                ...
                <tr>
                   ...
                   <!--  <td align="left" class="tdbgwhite"><input class="outputDate" id="outputDate" name="outputDate" value="2014-06-19" style="width: 101px; "/></td> -->
                    ...
                    <td align="left" class="tdbgwhite"><input name="submitButton" type="Submit" class="but"
														...
														<input name="WhatFor" type="hidden" id="WhatFor" value="shortlistJob"></td>
                    <td align="left" class="tdbgwhite"></td>
                    <td align="left" class="tdbgwhite"></td>
                    <td align="left" class="tdbgwhite">
