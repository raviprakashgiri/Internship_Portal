...
<%
	String query = "select ra_id,first_name,persuing,cgpa,stream,availabilityForF2F,email_id from ra_applicant where status='Rejected'";
...
<tr>
	<td width="1%"><img src="images/1.gif" alt="" width="16"
		height="57"></td>
	<td width="98%" background="images/2.gif" class="bigtitlered"> Rejected RA List		
	</td>
