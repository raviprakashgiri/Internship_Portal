...
<%
	String query = "select intern_id,first_name,persuing,cgpa,stream,internship_duration,availabilityForF2F from intern where status='Pending'";
			...
			<tr>
				...
				<td align="left" class="tdbgwhite">
					<select name="actions" id="actions" class="<%=data[count][0]%>">
						...
						<option value="shortListIntern">Short List</option>
