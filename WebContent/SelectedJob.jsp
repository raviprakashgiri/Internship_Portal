...
<title>Selected JOB Candidates</title>
...
<%
	...
	String query = "select job_applicant_id,first_name,last_name,date_from from job_shortlisted where date_from between '"+fromDate+"' and '"+toDate+"'";
