...
<title>Interns Rejected list</title>
...
<%
	String query = "select intern_id,first_name,persuing,cgpa,stream,internship_duration,availabilityForF2F from intern where status='Rejected'";
...
<tr>
	<td width="1%"><img src="images/1.gif" alt="" width="16"
		height="57"></td>
	<td width="98%" background="images/2.gif" class="bigtitlered"> Rejected Interns List		
	</td>
...
<tr>
	...
	<td bgcolor="#FFFFFF"><table width="98%" border="0" align="center"
			...
			<tr>
				...
				<td align="left" class="tdbgwhite"><a href="InternDetails.jsp?intern_id=<%=data[count][0]%>">View</a></td>
				<td align="left" class="tdbgwhite">
					<select name="actions" id="actions" class="<%=data[count][0]%>">
						...
						<option value="deleteIntern">Delete</option>
					</select>
				</td>
			</tr>
			<%} %>
