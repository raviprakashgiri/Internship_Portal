...
<title>Interns ShortListed list</title>
...
<%
	String query = "select intern_id,first_name,persuing,cgpa,stream,internship_duration,availabilityForF2F from intern where status='ShortListed'";
